...
class Partner(models.Model):
    ...
    def _notify(
        ...
        try:
            ...
            ).with_context(lang=base_template_ctx["lang"])
        except ValueError:
            _logger.warning(
        ...
        create_values = {
            ...
            "email_cc": ",".join(self.append_email_address_in_email(cc_ids))
            if cc_ids
            else "",
            "email_bcc": ",".join(self.append_email_address_in_email(bcc_ids))
            if bcc_ids
            else "",
        }
