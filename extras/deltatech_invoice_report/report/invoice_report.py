...
class AccountInvoiceReport(models.Model):
    ...
    #tipo_de_contacto = fields.Many2one("res.partner", string="Tipo de Contacto", readonly=True)

    def _select(self):
        return super(AccountInvoiceReport, self)._select() + ", sub.state_id,    sub.supplier_id"
    ...
    def _sub_select(self):
        return super(AccountInvoiceReport, self)._sub_select() + ", partner.state_id,   supplier.name as supplier_id"
