...
class StockBalance(models.Model):
    ...
    barcode = fields.Many2one("product.template", "Barcode", readonly=True)
    ...
    product_qty = fields.Float("Quantity", digits_=dp.get_precision("Product Unit of Measure"), readonly=True)
