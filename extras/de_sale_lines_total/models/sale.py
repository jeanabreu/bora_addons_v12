...
class PickingTotalQty(models.Model):
    ...
    tot_sale_qty = fields.Float(compute='_calculate_sale_qty', string='Total Cant. Vendida', help="Total sale quantity in active document")
    tot_delivered_qty = fields.Float(compute='_calculate_delivered_qty', string='Total Cant. Enviada',
                                help="Total Delivered quantity in active document")
    tot_invoiced_qty = fields.Float(compute='_calculate_invoiced_qty', string='Total Cant. Facturada',
