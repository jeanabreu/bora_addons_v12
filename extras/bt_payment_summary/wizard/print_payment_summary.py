...
class PrintPaymentSummary(models.TransientModel):
    ...
    def action_print_payment_summary(self,):
        ...
        worksheet.write(1, 6, _('Vendedor'), column_heading_style)
        ...
        customer_row = 2
        for wizard in self:
            heading =  'Reporte de Pagos de Proveedores y Cobros de Clientes (' + str(wizard.currency_id.name) + ')'
            worksheet.write_merge(0, 0, 0, 6, heading, easyxf('font:height 200; align: horiz center;pattern: pattern solid, fore_color black; font: color white; font:bold True;' "borders: top thin,bottom thin"))
