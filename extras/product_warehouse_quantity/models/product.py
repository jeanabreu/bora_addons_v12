...
class ProductTemplate(models.Model):
    ...
    warehouse_quantity = fields.Char(compute='_get_warehouse_quantity', string='Cantidad por Almacen')
            ...
            if product_id:
                ...
                for item in tt_warehouses:
                    if tt_warehouses[item] != 0:
                        #warehouse_quantity_text = '<p>' + warehouse_quantity_text  + item + ': ' + str(tt_warehouses[item]) + '</p>'
